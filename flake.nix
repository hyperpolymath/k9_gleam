{
  description = "k9_gleam - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 k9_gleam development environment"
            echo "Language: gleam"
            echo ""
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P k9_gleam.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/k9_gleam $out/bin/  # Rust
            # cp bin/k9_gleam $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/k9_gleam";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-k9_gleam" {
