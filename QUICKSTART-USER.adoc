...
// Replace k9_gleam, K9_Gleam — See README.adoc for details., just run, K9_Gleam started successfully. with actuals
= k9_gleam — Quick Start for Users
:toc:
:toclevels: 2

== What is k9_gleam?

K9_Gleam — See README.adoc for details.
...
----
# Clone and set up
git clone https://github.com/hyperpolymath/k9_gleam.git
cd k9_gleam
just setup
----
...
[source,bash]
----
just install --portable --prefix=./k9_gleam-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/k9_gleam/wiki
